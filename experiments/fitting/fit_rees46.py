...
Usage:
    python experiments/fitting/fit_rees46.py          # all k values
    python experiments/fitting/fit_rees46.py --k 21   # single k
"""
...
RESULTS_DIR = os.path.join(REPO_ROOT, 'results', 'rees46')
