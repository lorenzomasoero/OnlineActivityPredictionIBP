"""Jackknife estimator for species richness extrapolation."""
...
def harmonic(N):
    '''
        Returns n-th harmonic number; See Gravel (2014) et al.
    '''
    if(N < 20):
...
+ 6*(-4 + N)*(-1 + N)**3*(-3 + 2*N)*(6 - 5*N + N**2)**2*(-1494 + 2874*N - 2121*N**2 + 758*N**3 - 132*N**4 + 9*N**5)*delta**3)*sfs_0[3])/((-2 + N)*(-1 + N)**3*N*(-5 + 2*N)*(-3 + 2*N)*(5 - 5*N + N**2)*(26 - 18*N + 3*N**2)*(11 - 12*N + 3*N**2)) + (delta*(-12*(3 - 2*N)**2*(-4 + N)**4*(-3 + N) *(11 - 12*N + 3*N**2)**2 - 12*(-4 + N)**4*(-1 + N)*(9 - 9*N + 2*N**2)*(-803 + 2196*N - 2363*N**2 + 1249*N**3 - 324*N**4 + 33*N**5)*delta- 24*(-4 + N)**4*(-1 + N)**2*(-3 + 2*N)*(6 - 5*N + N**2)*(143 - 299*N + 228*N**2 - 75*N**3 + 9*N**4)*delta**2 - 12*(-4 + N)**4*(-1 + N)**3*(-3 + 2*N)*(6 - 5*N + N**2)**2*(11 - 12*N + 3*N**2)*delta**3)*sfs_0[4])/((-2 + N)*(-1 + N)**3*N*(-7 + 2*N)*(-5 + 2*N)*(-3 + 2*N)*(5 - 5*N + N**2)*(26 - 18*N + 3*N**2)*(11 - 12*N + 3*N**2))
    return missed
